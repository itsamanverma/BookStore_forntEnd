...
class BookStoreIcon extends Component {
    render() {
        return (
            <div className="fitWidth">
                ...
                <span style={{color:'#EA4335',fontSize:'20px',fontWeight:500}}>o</span>
                <span style={{color:'#FBBD35',fontSize:'20px',fontWeight:500}}>r</span>
                <span style={{color:'#4385F4',fontSize:'20px',fontWeight:500}}>e</span>
            </div>
        );
    }
}
